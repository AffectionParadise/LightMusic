...
public class Fonts {
    ...
    private static final String NORMAL_NAME = "msyhbd.ttc";
    public static final String NORMAL_BOLD_NAME = "msyhbd.ttc";
...
//    public static final Font NORMAL_HUGE = new Font("微软雅黑", Font.BOLD, HUGE_SIZE);
    // 韩语 俄语
    ...
    public static final Font[] TYPES = {NORMAL, MALGUN_GOTHIC, CALIBRI, HIMALAYA, TIMES_NEW_ROMAN, MS_GOTHIC, EMOJI, LEELAWADEE};
    public static final Font[] TYPES_BIG = {NORMAL_BIG, MALGUN_GOTHIC_BIG, CALIBRI_BIG, HIMALAYA_BIG, TIMES_NEW_ROMAN_BIG, MS_GOTHIC_BIG, EMOJI_BIG, LEELAWADEE_BIG};
    public static final Font[] TYPES_HUGE = {NORMAL_HUGE, MALGUN_GOTHIC_HUGE, CALIBRI_HUGE, HIMALAYA_HUGE, TIMES_NEW_ROMAN_HUGE, MS_GOTHIC_HUGE, EMOJI_HUGE, LEELAWADEE_HUGE};
}
