...
//
//public class LrcScrollPane extends CustomScrollPane {
//    @Getter
...
//    private MainFrame f;
//
//    public LrcScrollPane(MainFrame f, Component comp) {
//        super(comp);
//        this.f = f;
//        drawSpectrum = false;
//
...
//                    int y1 = ph - sHeight;
//                    int x2 = viewX + SpectrumConstants.BAR_WIDTH / 2 + (i + 1) * (SpectrumConstants.BAR_WIDTH + SpectrumConstants.BAR_GAP);
...
//                    int p1y = ph - sHeight;
//                    int p2x = viewX + SpectrumConstants.BAR_WIDTH / 2 + (i + 1) * (SpectrumConstants.BAR_WIDTH + SpectrumConstants.BAR_GAP);
...
//                    p1y = ph - sHeight;
//                    p2x = viewX + SpectrumConstants.BAR_WIDTH / 2 + (i + 1) * (SpectrumConstants.BAR_WIDTH + SpectrumConstants.BAR_GAP);
