...
// * @Date 2020/12/21
// */
//public class LoadingPanel2 extends JComponent implements MouseListener {
...
//
//    public LoadingPanel2(MainFrame f) {
//        this("");
//        this.f = f;
//    }
//
//    public LoadingPanel2(String text) {
//        this(text, 14);
//    }
//
//    public LoadingPanel2(String text, int barsCount) {
//        this(text, barsCount, 0.4f);
//    }
//
//    public LoadingPanel2(String text, int barsCount, float shield) {
//        this(text, barsCount, shield, 15);
//    }
//
//    public LoadingPanel2(String text, int barsCount, float shield, float fps) {
//        this(text, barsCount, shield, fps, 200);
//    }
//
//    public LoadingPanel2(String text, int barsCount, float shield, float fps, int rampDelay) {
//        this.text = text;
...
//
//                setVisible(false);
//                removeMouseListener(LoadingPanel2.this);
//            }
//        }
//    }
//
