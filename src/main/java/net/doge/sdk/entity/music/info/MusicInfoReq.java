...
import net.doge.sdk.entity.music.info.lyrichero.kg.KgLyricHero;
import net.doge.sdk.entity.music.info.lyrichero.kw.KwLyricHero;
import net.doge.sdk.entity.music.info.lyrichero.mg.MgLyricHero;
    ...
    public void fillMusicInfo(NetMusicInfo musicInfo) {
        ...
        // 酷狗
            ...
            if (JsonUtil.isEmpty(data)) {
                ...
                songBody = SdkCommon.kgRequest(null, dat, options)
...
//            if (!musicInfo.hasLrc()) musicInfo.setLrc(data.getString("lyrics"));
        ...
        // 酷我
            ...
            HttpResponse resp = SdkCommon.kwRequest(String.format(SINGLE_SONG_DETAIL_KW_API, id)).executeAsync();
