...
//    private final String GET_SONG_URL_MG_API = "https://c.musicapp.migu.cn/MIGUM2.0/v1.0/content/resourceinfo.do?copyrightId=%s&resourceType=2";
    ...
    // 歌曲 URL 获取 API (发姐)
    private final String GET_SONG_URL_FA_API = "https://www.chatcyf.com/wp-admin/admin-ajax.php?action=hermit" +
...
//            }
        ...
        // 发姐
            ...
            String songInfoBody = HttpRequest.get(GET_SONG_URL_FA_API)
                    .executeAsync()
                    .body();
