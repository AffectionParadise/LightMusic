...
public class KwTrackHeroV4 {
    private static KwTrackHeroV4 instance;

    private KwTrackHeroV4() {
        initMap();
    }

    public static KwTrackHeroV4 getInstance() {
        if (instance == null) instance = new KwTrackHeroV4();
        return instance;
    }
    ...
    public String getTrackUrl(String mid, String quality) {
        String params = String.format("user=0611d9b202ca0820&android_id=0611d9b202ca0820&prod=kwplayer_ar_11.3.0.0&corp=kuwo&newver=3&vipver=11.3.0.0&source=kwwear_ar_2.2.3_Fwatch.apk&p2p=1&q36=8899378ed08282acc723cdbc100010615202&approval=false&loginUid=0&loginSid=0&appuid=2788274549&allpay=0&notrace=0&oaid=3d3e1ab6-b5a1-4767-be7c-55fe63786812&type=convert_url_with_sign&br=%s%s&format=%s&sig=0&rid=%s&priority=bitrate&network=4G&localUid=-1&mode=audition&from=PC&token=bad205aa9e8a50181d948b1cafc16091&bc_token=1462dab652d0a688811e13bddf48596a&timestamp=1755249729&uid=2788274549", hMap.get(quality), eMap.get(quality), eMap.get(quality), mid);
