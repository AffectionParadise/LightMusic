...
public class KwTrackHeroV4 {
    ...
    public String getTrackUrl(String mid, String quality) {
        String params = String.format("corp=kuwo&source=kwplayer_ar_1.1.9_oppo_118980_320.apk&p2p=1&sig=0&type=convert_url_with_sign&br=%s%s&format=%s" +
                "&rid=%s&&notrace=0&priority=bitrate&network=WIFI&mode=down", hMap.get(quality), eMap.get(quality), eMap.get(quality), mid);
