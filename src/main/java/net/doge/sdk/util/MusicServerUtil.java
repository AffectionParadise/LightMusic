...
import net.doge.sdk.album.search.AlbumSearchReq;
import net.doge.sdk.album.tag.NewAlbumTagReq;
import net.doge.sdk.artist.info.ArtistInfoReq;
import net.doge.sdk.artist.menu.ArtistMenuReq;
import net.doge.sdk.artist.rcmd.ArtistListReq;
import net.doge.sdk.artist.search.ArtistSearchReq;
import net.doge.sdk.artist.tag.ArtistTagReq;
import net.doge.sdk.comment.CommentReq;
import net.doge.sdk.core.DownloadReq;
import net.doge.sdk.core.MottoReq;
import net.doge.sdk.music.info.MusicInfoReq;
import net.doge.sdk.music.info.MusicUrlReq;
import net.doge.sdk.music.menu.MusicMenuReq;
import net.doge.sdk.music.rcmd.HotMusicRecommendReq;
import net.doge.sdk.music.rcmd.NewMusicReq;
import net.doge.sdk.music.rcmd.RecommendProgramReq;
import net.doge.sdk.music.search.HotSearchReq;
import net.doge.sdk.music.search.MusicSearchReq;
import net.doge.sdk.music.search.SearchSuggestionReq;
import net.doge.sdk.music.tag.HotSongTagReq;
import net.doge.sdk.music.tag.MusicSearchTagReq;
import net.doge.sdk.music.tag.NewSongTagReq;
import net.doge.sdk.music.tag.ProgramTagReq;
import net.doge.sdk.mv.info.MvInfoReq;
import net.doge.sdk.mv.info.MvUrlReq;
import net.doge.sdk.mv.menu.MvMenuReq;
import net.doge.sdk.mv.rcmd.RecommendMvReq;
import net.doge.sdk.mv.search.MvSearchReq;
import net.doge.sdk.mv.tag.MvTagReq;
import net.doge.sdk.playlist.info.PlaylistInfoReq;
import net.doge.sdk.playlist.menu.PlaylistMenuReq;
...
import net.doge.sdk.radio.rcmd.HotRadioReq;
import net.doge.sdk.radio.rcmd.NewRadioReq;
import net.doge.sdk.radio.search.RadioSearchReq;
import net.doge.sdk.radio.tag.HotRadioTag;
import net.doge.sdk.ranking.info.RankingInfoReq;
import net.doge.sdk.ranking.search.GetRankingReq;
import net.doge.sdk.sheet.SheetReq;
...
public class MusicServerUtil {
    ...
    public static CommonResult<NetMusicInfo> getMusicInfoInArtist(String artistId, int source, int limit, int page) {
        return new ArtistInfoReq().getMusicInfoInArtist(artistId, source, limit, page);
    }
