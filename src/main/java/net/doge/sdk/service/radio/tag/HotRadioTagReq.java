...
import net.doge.sdk.service.radio.tag.impl.DbHotRadioTagReq;
import net.doge.sdk.service.radio.tag.impl.MeHotRadioTagReq;
import net.doge.sdk.service.radio.tag.impl.NcHotRadioTagReq;
import net.doge.sdk.service.radio.tag.impl.XmHotRadioTagReq;
...
public class HotRadioTagReq {
    ...
    public void initRadioTag() {
        ...
        executor.submit(() -> XmHotRadioTagReq.getInstance().initRankingTag());
