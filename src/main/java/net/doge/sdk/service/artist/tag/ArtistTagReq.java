...
public class ArtistTagReq {
    ...
    public void initArtistTag() {
        ...
        Tags.artistTag.put("默认", new String[]{"1", "", "", "0 0", "", "-100 -100 -100 -100", "11", "0 ", "huayu-nan", "  ", " "});
        ...
        Tags.artistTag.put("华语男", new String[]{"", "1 7 -1", "", "1 1", "", "", "", "1 ", "huayu-nan", "", ""});
        Tags.artistTag.put("华语女", new String[]{"", "2 7 -1", "", "2 1", "", "", "", "2 ", "huayu-nv", "", ""});
        Tags.artistTag.put("华语组合", new String[]{"", "3 7 -1", "", "3 1", "", "", "", "3 ", "huayu-group", "", ""});
        ...
        Tags.artistTag.put("欧美男", new String[]{"", "1 96 -1", "", "1 2", "", "0 -100 -100 5", "", "7 ", "oumei-nan", " 欧美 男", ""});
        Tags.artistTag.put("欧美女", new String[]{"", "2 96 -1", "", "2 2", "", "1 -100 -100 5", "", "8 ", "oumei-nv", " 欧美 女", ""});
        Tags.artistTag.put("欧美组合", new String[]{"", "3 96 -1", "", "3 2", "", "2 -100 -100 5", "", "9 ", "oumei-group", " 欧美 组合", ""});
        ...
        Tags.artistTag.put("日韩男", new String[]{"", "", "", "1 3", "", "", "", "4 ", "rihan-nan", "", ""});
        Tags.artistTag.put("日韩女", new String[]{"", "", "", "2 3", "", "", "", "5 ", "rihan-nv", "", ""});
        Tags.artistTag.put("日韩组合", new String[]{"", "", "", "3 3", "", "", "", "6 ", "rihan-group", "", ""});
