...
public class NcArtistTagReq {
    private static NcArtistTagReq instance;

    private NcArtistTagReq() {
    }

    public static NcArtistTagReq getInstance() {
        if (instance == null) instance = new NcArtistTagReq();
        return instance;
    }
    ...
    public void initStyleArtistTag() {
        ...
        for (int i = 0, len = tags.size(); i < len; i++) {
            ...
            Tags.artistTags.get(name)[TagType.STYLE_ARTIST_NC] = id;
            // 子标签
            ...
            for (int j = 0, s = subTags.size(); j < s; j++) {
                ...
                Tags.artistTags.get(subName)[TagType.STYLE_ARTIST_NC] = subId;
                // 孙子标签
                ...
                for (int k = 0, l = ssTags.size(); k < l; k++) {
                    ...
                    Tags.artistTags.get(ssName)[TagType.STYLE_ARTIST_NC] = ssId;
                }
            }
        }
    }
