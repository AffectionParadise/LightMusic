...
public class KgArtistTagReq {
    private static KgArtistTagReq instance;

    private KgArtistTagReq() {
    }

    public static KgArtistTagReq getInstance() {
        if (instance == null) instance = new KgArtistTagReq();
        return instance;
    }
    ...
    public void initIpTag() {
        ...
        for (int i = 0, len = tags.size(); i < len; i++) {
            ...
            Tags.artistTags.get(name)[TagType.IP_ARTIST_KG] = id;
        }
    }
}
