package net.doge.sdk.service.sheet.impl;
...
public class NcSheetReq {
    private static NcSheetReq instance;

    private NcSheetReq() {
    }

    public static NcSheetReq getInstance() {
        if (instance == null) instance = new NcSheetReq();
        return instance;
    }
