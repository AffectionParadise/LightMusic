...
public class CunYuNcTrackReq {
    private static CunYuNcTrackReq instance;

    private CunYuNcTrackReq() {
        initMap();
    }

    public static CunYuNcTrackReq getInstance() {
        if (instance == null) instance = new CunYuNcTrackReq();
        return instance;
    }
...
//        CunYuNcTrackReq trackReq = getInstance();
