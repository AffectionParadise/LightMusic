...
//
//public class LuoyueQqTrackReq {
//    private static LuoyueQqTrackReq instance;
//
//    private LuoyueQqTrackReq() {
//        initMap();
//    }
//
//    public static LuoyueQqTrackReq getInstance() {
//        if (instance == null) instance = new LuoyueQqTrackReq();
//        return instance;
//    }
//
//    // 歌曲 URL 获取 API (QQ)
//    private final String SONG_URL_QQ_API = "http://220.167.101.253:6001/api/musics/url/tx/%s/%s";
//
...
//                    .header(Header.X_REQUEST_KEY, "lxmusic")
//                    .executeAsStr();
...
//        LuoyueQqTrackReq trackHero = getInstance();
