...
//
//public class TangQqTrackReq {
//    private static TangQqTrackReq instance;
//
//    private TangQqTrackReq() {
//        initMap();
//    }
//
//    public static TangQqTrackReq getInstance() {
//        if (instance == null) instance = new TangQqTrackReq();
//        return instance;
//    }
//
//    // 歌曲 URL 获取 API (QQ)
//    private final String SONG_URL_QQ_API = "https://tang.api.s01s.cn/music_open_api.php?mid=%s";
//
...
//        TangQqTrackReq trackHero = getInstance();
