package net.doge.sdk.service.music.info.impl.musicinfo.lyric.qq;

import com.alibaba.fastjson2.JSONObject;
import net.doge.constant.core.lyric.LyricPattern;
import net.doge.entity.service.NetMusicInfo;
import net.doge.sdk.common.SdkCommon;
import net.doge.sdk.service.music.info.impl.musicinfo.lyric.qq.decoder.QrcDecoder;
...
public class QqLyricReq {
    private static QqLyricReq instance;

    private QqLyricReq() {
    }

    public static QqLyricReq getInstance() {
        if (instance == null) instance = new QqLyricReq();
        return instance;
    }
