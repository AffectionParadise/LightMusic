package net.doge.sdk.service.music.info.impl.musicinfo.lyric.kg;
...
public class KgLyricReq {
    private static KgLyricReq instance;

    private KgLyricReq() {
    }

    public static KgLyricReq getInstance() {
        if (instance == null) instance = new KgLyricReq();
        return instance;
    }
