...
public class HfMusicInfoReq {
    private static HfMusicInfoReq instance;

    private HfMusicInfoReq() {
    }

    public static HfMusicInfoReq getInstance() {
        if (instance == null) instance = new HfMusicInfoReq();
        return instance;
    }
