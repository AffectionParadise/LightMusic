package net.doge.sdk.service.music.info.impl.musicurl.track.kw;
...
public class KwTrackReqV3 {
    private static KwTrackReqV3 instance;

    private KwTrackReqV3() {
        initMap();
        initBlacklist();
    }

    public static KwTrackReqV3 getInstance() {
        if (instance == null) instance = new KwTrackReqV3();
        return instance;
    }
