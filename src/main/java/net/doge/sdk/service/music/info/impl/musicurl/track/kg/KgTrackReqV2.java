...
public class KgTrackReqV2 {
    private static KgTrackReqV2 instance;

    private KgTrackReqV2() {
        initMap();
    }

    public static KgTrackReqV2 getInstance() {
        if (instance == null) instance = new KgTrackReqV2();
        return instance;
    }
