...
public class CggKgTrackReq {
    private static CggKgTrackReq instance;

    private CggKgTrackReq() {
        initMap();
    }

    public static CggKgTrackReq getInstance() {
        if (instance == null) instance = new CggKgTrackReq();
        return instance;
    }
