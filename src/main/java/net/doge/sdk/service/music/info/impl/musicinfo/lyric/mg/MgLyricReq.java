package net.doge.sdk.service.music.info.impl.musicinfo.lyric.mg;

import com.alibaba.fastjson2.JSONObject;
import net.doge.constant.core.lyric.LyricPattern;
import net.doge.entity.service.NetMusicInfo;
import net.doge.sdk.service.music.info.impl.musicinfo.lyric.mg.decoder.MrcDecoder;
...
public class MgLyricReq {
    private static MgLyricReq instance;

    private MgLyricReq() {
    }

    public static MgLyricReq getInstance() {
        if (instance == null) instance = new MgLyricReq();
        return instance;
    }
