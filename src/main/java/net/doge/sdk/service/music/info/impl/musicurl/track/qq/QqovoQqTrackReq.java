...
public class QqovoQqTrackReq {
    private static QqovoQqTrackReq instance;

    private QqovoQqTrackReq() {
        initMap();
    }

    public static QqovoQqTrackReq getInstance() {
        if (instance == null) instance = new QqovoQqTrackReq();
        return instance;
    }
    ...
    private final String SONG_URL_QQ_API = "https://qqovo.top/api/meting?server=tencent&type=url&id=%s&quality=%s";
    ...
    private void initMap() {
        ...
        qualityMap.put(AudioQuality.KEYS[AudioQuality.SUPER], "exhigh");
    ...
    public String getTrackUrl(String mid, String quality) {
        try {
            ...
            // 获取 url
            String url = String.format(SONG_URL_QQ_API, mid, qualityMap.get(quality));
    ...
    public static void main(String[] args) {
        QqovoQqTrackReq trackReq = getInstance();
