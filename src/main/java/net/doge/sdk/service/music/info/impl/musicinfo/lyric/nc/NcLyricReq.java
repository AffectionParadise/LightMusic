package net.doge.sdk.service.music.info.impl.musicinfo.lyric.nc;
...
public class NcLyricReq {
    private static NcLyricReq instance;

    private NcLyricReq() {
    }

    public static NcLyricReq getInstance() {
        if (instance == null) instance = new NcLyricReq();
        return instance;
    }
