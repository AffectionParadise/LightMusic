...
public class GgUserInfoReq {
    private static GgUserInfoReq instance;

    private GgUserInfoReq() {
    }

    public static GgUserInfoReq getInstance() {
        if (instance == null) instance = new GgUserInfoReq();
        return instance;
    }
    ...
    public CommonResult<NetUserInfo> getUserInfo(String id) {
        ...
        userInfo.setSource(NetResourceSource.GG);
