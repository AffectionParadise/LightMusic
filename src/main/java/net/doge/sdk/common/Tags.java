...
public class Tags {
    ...
    public static int[] recPlaylistMap = {NetMusicSource.NET_CLOUD, NetMusicSource.KG, NetMusicSource.QQ, NetMusicSource.ME, NetMusicSource.FS};
    ...
    public static int[] newSongMap = {NetMusicSource.NET_CLOUD, NetMusicSource.NET_CLOUD, NetMusicSource.KG, NetMusicSource.QQ,
