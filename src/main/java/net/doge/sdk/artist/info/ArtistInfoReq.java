package net.doge.sdk.artist.info;
...
//            }
     ...
     */
    public CommonResult<NetMusicInfo> getMusicInfoInArtist(String artistId, int source, int limit, int page) {
        int total = 0;
        ...
        // 酷我
            ...
            String artistInfoBody = SdkCommon.kwRequest(String.format(ARTIST_SONGS_KW_API, artistId, page, limit))
        ...
        // 千千
            ...
            String artistInfoBody = HttpRequest.get(SdkCommon.buildQianUrl(String.format(ARTIST_SONGS_QI_API, artistId, page, limit, System.currentTimeMillis())))
                    .execute()
                    .body();
            JSONObject artistInfoJson = JSONObject.fromObject(artistInfoBody);
            JSONObject data = artistInfoJson.getJSONObject("data");
